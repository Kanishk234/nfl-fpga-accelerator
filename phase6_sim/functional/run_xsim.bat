...
REM   python phase6_sim/functional/check_results.py
...
echo.
echo ============================================================
echo  Done. Results: phase6_sim\functional\sim_results.csv
echo  Next, in WSL:  python phase6_sim/functional/check_results.py
echo ============================================================
pause
