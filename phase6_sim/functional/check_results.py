...
Reads:
  phase6_sim/functional/golden.csv       (game_idx, home, away, win_prob, spread, win_byte, spread_byte)
  phase6_sim/functional/sim_results.csv   (game_idx, win_byte, spread_byte, timeout)   <- from XSIM/iverilog
...
Run from project root:
    python phase6_sim/functional/check_results.py [sim_results.csv]
"""
import sys, csv

FUNC = 'phase6_sim/functional'
