...
Windows-friendly: needs only pyserial + validation_vectors.json.
    ...
    python phase7_deploy_conifer/validation/golden_vector_test_gbdt.py COM8 --n 20
"""
import argparse
import json
import statistics
...
from phase7_deploy_conifer.inference.fpga_client_gbdt import GBDTClient, from_fixed
