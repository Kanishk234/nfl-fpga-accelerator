...
mlp/phase6_sim/functional/check_results.py in the MLP flow (which needed a +/-3
...
Run from project root (WSL) after run_xsim_gbdt.bat:
    python gbdt/phase6_sim/check_results.py
"""
...
SCALE = 1 << 12
GOLDEN = 'gbdt/phase6_sim/chain_golden/golden_chain.npy'
RESULTS = 'gbdt/phase6_sim/sim_results.csv'
