...
| File | Role |
|---|---|
| `gbdt/phase2_train/train_gbdt.py` | Data loading, stacked training (win → spread), evaluation, artifact save |
| `gbdt/phase2_train/__init__.py` | Package marker |
...
python gbdt/phase2_train/train_gbdt.py    # trains both stages, saves artifacts/gbdt/
```
