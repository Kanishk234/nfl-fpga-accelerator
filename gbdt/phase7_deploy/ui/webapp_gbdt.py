...
The GBDT twin of mlp/phase7_deploy/ui/webapp.py. Backend is the Python standard
...
once in WSL by export_catalog_gbdt.py).
    ...
    python gbdt/phase7_deploy/ui/webapp_gbdt.py --port 9000 --no-browser

It deliberately serves the SAME mlp/phase7_deploy/ui/index.html as the MLP app
...
from gbdt.phase7_deploy.inference.fpga_client_gbdt import GBDTClient

REPO = Path(__file__).resolve().parents[3]
# Shared with the MLP app — single source of truth for the page.
INDEX = REPO / 'mlp/phase7_deploy' / 'ui' / 'index.html'
CATALOG_PATH = REPO / 'gbdt/phase7_deploy' / 'games_catalog_gbdt.json'
CATALOG = None
