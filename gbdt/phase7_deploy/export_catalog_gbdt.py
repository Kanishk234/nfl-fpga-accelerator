...
byte-identical to gbdt/phase6_sim/chain_golden/tb_inputs.mem — the board
...
OUT = Path('gbdt/phase7_deploy/games_catalog_gbdt.json')
VEC_OUT = Path('gbdt/phase7_deploy/validation_vectors.json')
CHAIN = Path('gbdt/phase6_sim/chain_golden')
SIM_RESULTS = Path('gbdt/phase6_sim/sim_results.csv')
...
def export_validation_vectors(b):
    ...
    VEC_OUT.write_text(json.dumps({
        ...
        'source': 'gbdt/phase6_sim/chain_golden',
        'n': len(vectors),
