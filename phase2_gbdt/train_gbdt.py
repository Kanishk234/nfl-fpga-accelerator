...
Parallel track to phase2_model (the Keras MLP). Same 21 features, same
...
Run from project root:
    python phase2_gbdt/train_gbdt.py
"""
...
# ---------------------------------------------------------------------------
# Data loading and splitting — mirrors phase2_model/train.py exactly
# ---------------------------------------------------------------------------
