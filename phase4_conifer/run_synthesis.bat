...
REM Mirrors phase4_hls\run_synthesis.bat: copy to a local Windows path first
...
echo    phase4_conifer\hls_win\conifer_win\solution1\syn\report\
echo    phase4_conifer\hls_spread\conifer_spread\solution1\syn\report\
echo ============================================================
