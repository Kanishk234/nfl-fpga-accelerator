...
MLP flow — see phase4_hls/run_synthesis.bat for why).

Run from project root (WSL):
    python phase4_conifer/convert_hls.py
"""
...
def emit(booster, name):
    ...
    cfg['OutputDir'] = f'phase4_conifer/hls_{name}'
...
if __name__ == '__main__':
    ...
    print("\nNext: run phase4_conifer/run_synthesis.bat on Windows.")
