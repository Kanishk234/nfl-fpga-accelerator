...
entity myproject_fifo_w2304_d1_S is 
    generic (
...
architecture rtl of myproject_fifo_w2304_d1_S is
...
------------------------Component----------------------
    component myproject_fifo_w2304_d1_S_ShiftReg is
    generic (
        DATA_WIDTH : integer := 2304;
        ADDR_WIDTH : integer := 1;
        DEPTH      : integer := 1);
...
begin
----------------------- Instantiation -----------------------
    U_myproject_fifo_w2304_d1_S_ShiftReg : myproject_fifo_w2304_d1_S_ShiftReg
    generic map (
...
entity myproject_fifo_w2304_d1_S_ShiftReg is
    generic (
        DATA_WIDTH : integer := 2304;
        ADDR_WIDTH : integer := 1;
        DEPTH      : integer := 1);
    port (
        ...
        din        : in std_logic_vector(DATA_WIDTH-1 downto 0);
        dout       : out std_logic_vector(DATA_WIDTH-1 downto 0));
end myproject_fifo_w2304_d1_S_ShiftReg;

architecture rtl of myproject_fifo_w2304_d1_S_ShiftReg is
