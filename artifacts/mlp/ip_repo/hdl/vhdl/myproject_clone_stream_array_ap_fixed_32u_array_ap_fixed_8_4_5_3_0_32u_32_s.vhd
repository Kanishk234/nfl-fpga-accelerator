...
entity myproject_clone_stream_array_ap_fixed_32u_array_ap_fixed_8_4_5_3_0_32u_32_s is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of myproject_clone_stream_array_ap_fixed_32u_array_ap_fixed_8_4_5_3_0_32u_32_s is 
...
begin
    ...
    ap_block_state1_assign_proc : process(real_start, ap_done_reg, layer7_out_empty_n, layer11_cpy1_full_n, layer11_cpy2_full_n)
    begin
                ap_block_state1 <= ((real_start = ap_const_logic_0) or (layer11_cpy2_full_n = ap_const_logic_0) or (layer11_cpy1_full_n = ap_const_logic_0) or (layer7_out_empty_n = ap_const_logic_0) or (ap_done_reg = ap_const_logic_1));
    end process;
    ...
    layer11_cpy1_blk_n_assign_proc : process(real_start, ap_done_reg, ap_CS_fsm_state1, layer11_cpy1_full_n)
    begin
        if ((not(((real_start = ap_const_logic_0) or (ap_done_reg = ap_const_logic_1))) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
            layer11_cpy1_blk_n <= layer11_cpy1_full_n;
        else 
            layer11_cpy1_blk_n <= ap_const_logic_1;
        end if; 
    end process;

    layer11_cpy1_din <= layer7_out_dout;

    layer11_cpy1_write_assign_proc : process(ap_CS_fsm_state1, ap_block_state1)
    begin
        if (((ap_const_boolean_0 = ap_block_state1) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
            layer11_cpy1_write <= ap_const_logic_1;
        else 
            layer11_cpy1_write <= ap_const_logic_0;
        end if; 
    end process;


    layer11_cpy2_blk_n_assign_proc : process(real_start, ap_done_reg, ap_CS_fsm_state1, layer11_cpy2_full_n)
    begin
        if ((not(((real_start = ap_const_logic_0) or (ap_done_reg = ap_const_logic_1))) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
            layer11_cpy2_blk_n <= layer11_cpy2_full_n;
        else 
            layer11_cpy2_blk_n <= ap_const_logic_1;
        end if; 
    end process;

    layer11_cpy2_din <= layer7_out_dout;

    layer11_cpy2_write_assign_proc : process(ap_CS_fsm_state1, ap_block_state1)
    begin
        if (((ap_const_boolean_0 = ap_block_state1) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
            layer11_cpy2_write <= ap_const_logic_1;
        else 
            layer11_cpy2_write <= ap_const_logic_0;
        end if; 
    end process;
