...
are precomputed into mlp/phase7_deploy/games_catalog.json by export_catalog.py (run once in
...
UI shows win probability + point spread.
    ...
    source venv/bin/activate && python mlp/phase7_deploy/export_catalog.py
