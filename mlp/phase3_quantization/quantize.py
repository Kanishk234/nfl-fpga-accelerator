...
Run from project root:
    python mlp/phase3_quantization/quantize.py
...
from mlp.phase3_quantization.evaluate_quantized import (
    evaluate_both_models,
    run_sample_comparison,
    save_quantization_report,
)
from mlp.phase3_quantization.verify_hls_ready import verify_hls_ready
