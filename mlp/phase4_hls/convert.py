...
Run from project root:
    ...
    python mlp/phase4_hls/convert.py
"""
...
def convert_model(model, config, output_dir='mlp/phase4_hls/hls_project'):
    ...
    hls_model = hls4ml.converters.convert_from_keras_model(
        ...
        io_type='io_stream',      # io_stream: the maintained hls4ml path. Emits a proper #pragma HLS DATAFLOW
                                  ...
                                  # mlp/phase4_hls/patches/ do NOT apply to io_stream — do not overlay them.
    )
...
if __name__ == '__main__':
    ...
    hls_model = convert_model(model, config, output_dir='mlp/phase4_hls/hls_project')
    ...
    print(f"  HLS project:      mlp/phase4_hls/hls_project/")
    print("\nNext: run python mlp/phase4_hls/resource_report.py")
