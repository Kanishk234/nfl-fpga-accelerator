...
set WSL_HLS=\\wsl.localhost\Ubuntu\home\younix\nfl-fpga-accelerator\mlp\phase4_hls\hls_project
...
copy "\\wsl.localhost\Ubuntu\home\younix\nfl-fpga-accelerator\mlp\phase4_hls\synth_only.tcl" "%LOCAL_HLS%\synth_only.tcl"
...
echo  Reports: mlp\phase4_hls\hls_project\myproject_prj\solution1\syn\report\
echo.
echo  Next step -- run in WSL:
echo    python mlp/phase4_hls/resource_report.py
echo ============================================================
echo.
pause
