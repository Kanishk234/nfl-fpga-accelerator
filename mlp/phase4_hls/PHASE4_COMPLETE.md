...
cp mlp/phase4_hls/patches/nnet_dense_resource.h $TMPL/
cp mlp/phase4_hls/patches/nnet_activation.h     $TMPL/
```
Then re-run `python3 mlp/phase4_hls/convert.py`.
...
- IP zip: `mlp/phase4_hls/hls_project/myproject_prj/solution1/impl/ip/xilinx_com_hls_myproject_1_0.zip`
