...
REM Mirrors phase6_sim/functional/run_xsim.bat (same toolchain + C:\Temp staging).
REM
REM Run from Windows. Produces sim_results.csv back in the WSL tree; then in WSL:
REM   python phase6_sim_conifer/check_results.py
...
echo.
echo ============================================================
echo  Done. Results: phase6_sim_conifer\sim_results.csv
echo  Next, in WSL:  python phase6_sim_conifer/check_results.py
echo ============================================================
